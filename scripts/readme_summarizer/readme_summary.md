...
- [weekly-digest-gpt](#weekly-digest-gpt)
...
- [gpt-to-chatgpt-ts](#gpt-to-chatgpt-ts)
...
- [gpt-to-chatgpt-py](#gpt-to-chatgpt-py)
...
graph LR
    ...
    summarize-with-gpt3-obsidian --> bramses-highly-opinionated-vault-2023
    summarize-with-gpt3-obsidian --> obsidian-ghost-publish
    query-zettel-embeddings-obsidian --> bramses-highly-opinionated-vault-2023
    query-zettel-embeddings-obsidian --> obsidian-ghost-publish
    moon --> alfred-workflows
    eleven-labs-obsidian --> bramses-highly-opinionated-vault-2023
    eleven-labs-obsidian --> obsidian-ghost-publish
    ytclip-10s --> obsidian-ghost-publish
    ytclip-10s --> youtube-assets-from-video
    ytclip-10s --> alfred-workflows
    weekly-digest-gpt --> bramses-highly-opinionated-vault-2023
```
...
[link](https://github.com/bramses/weekly-digest-gpt)
...
## Installation of workflows

If you want to install a single workflow, click `View Raw` on the file you want download the .alfredworkflow file and double click it to open it in Alfred.

## Workflows

### yt-clip

Clip -15/+15 seconds from a YouTube video at a timestamp.

### PM Obsidian

Append to Resources or Kanban file in an Obsidian vault. [Learn more about this here](https://www.bramadams.dev/202305121544/#code)

### Important Apps Switcher

An example of how to use Alfred to set up hotkeys b/w different apps
...
Run `move_project` from root dir of project
...
[link](https://github.com/bramses/scripts/tree/main/move_project)
...
[link](https://github.com/bramses/gpt-to-chatgpt-ts)

## eleven-labs-obsidian

Path in Monorepo:
```
/_archive/eleven-labs-obsidian
```
...
Path in Monorepo:
```
/_archive/query-zettel-embeddings-obsidian
```
...
Path in Monorepo:
```
/_archive/summarize-with-gpt3-obsidian
```
...
[link](https://github.com/bramses/gpt-to-chatgpt-py)
